...
void ShaderQuad2D::set_camera_matrix(m3f3 _camera_matrix){
...
void ShaderQuad2D::set_model_texture(const m3f3 model_matrix, const unsigned int texture) const {
...
std::array<VertexQuad2D, 6> ShaderQuad2D::generate_quad_verts_c05()
{
