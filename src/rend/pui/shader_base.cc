...
void ShaderBase::set_viewport_transform(m4f4 _viewport_transform){
...
void ShaderBase::set(float* primitive_transform_4x4, float _darkness_shift, f4 color4) const {
