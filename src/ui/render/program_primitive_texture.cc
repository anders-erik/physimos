...
#include "program_primitive_texture.hh"
...
float textureSquareVertices[30] = {
...
void ProgramPrimitiveTexture::init(){
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(textureSquareVertices), textureSquareVertices, GL_STATIC_DRAW);
...
void ProgramPrimitiveTexture::set_viewport_transform(m4f4 _viewport_transform){
...
void ProgramPrimitiveTexture::draw() const {
...
void ProgramPrimitiveTexture::set(float* primitiveTransform_mat, unsigned int texture) const {
