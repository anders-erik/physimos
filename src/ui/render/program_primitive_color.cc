...
#include "program_primitive_color.hh"


namespace UI {


float colorSquareVertices[18] = {
...
void ProgramPrimitiveColor::set_viewport_transform(m4f4 _viewport_transform){
...
void ProgramPrimitiveColor::draw() const {
    glUseProgram(id);
...
void ProgramPrimitiveColor::set(float* primitive_transform_4x4, float _darkness_shift, UI::Color color4) const {
