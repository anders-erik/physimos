...
OUTPUT_BITMAP="characters-2-tall-reverse.bmp"
...
convert ${TMP_DIR}/${ORIG_BITMAP} -crop 100x150 +repage +adjoin ${TMP_DIR}/tile_%02d.bmp
...
convert ${TMP_DIR}/tall-cropped-inverted.bmp ${TMP_DIR}/output.bmp
