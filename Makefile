...
INC   := -I./include
LIB := -L./lib
SRCS := glad.c main.cpp Input.cpp ui.cpp shader.cpp Simulation.cpp Camera.cpp Windowing.cpp WorldObject.cpp WorldRenderer.cpp Model.cpp bmp_loader.cpp Timing.cpp WorldScene.cpp obj_loader.cpp RigidBody.cpp VectorMath.cpp process_info.cpp uiRenderer.cpp png_loader.cpp simulator.cpp wo_renderer.cpp
