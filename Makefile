...
INC   := -I./include
LIB := -L./lib
SRCS := glad.c main.cpp Input.cpp ui.cpp shader.cpp Simulation.cpp Camera.cpp Windowing.cpp WorldObject.cpp WorldRenderer.cpp Model.cpp bmp_loader.cpp Timing.cpp WorldScene.cpp obj_loader.cpp RigidBody.cpp VectorMath.cpp process_info.cpp uiRenderer.cpp png_loader.cpp SimWorldContainer.cpp wo_renderer.cpp Simulator.cpp Math.cpp
...
INC_HPP := shader.hpp shapes.hpp Simulation.hpp Types.hpp Camera.hpp Input.hpp WorldObject.hpp ui.hpp uiElement.hpp Model.hpp bmp_loader.hpp Windowing.hpp WorldRenderer.hpp Timing.hpp WorldScene.hpp obj_loader.hpp PSO_util.hpp RigidBody.hpp VectorMath.hpp process_info.hpp uiRenderer.hpp png_loader.hpp SimWorldContainer.hpp wo_renderer.hpp Simulator.hpp Math.hpp
